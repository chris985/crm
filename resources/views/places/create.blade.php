		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input id="address" class="form-control" name="address" type="text" aria-describedby="address">
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					<label class="text-muted" for="address2" ><i class="text-muted fa fa-street-view fa-fw mr-1"></i>Address 2</label>
					<input id="address2" class="form-control" name="address2" type="text" aria-describedby="address2">
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
					<label class="text-muted" for="city"><i class="text-muted fa fa-map-marker fa-fw mr-1"></i>City</label>
					<input id="city" class="form-control" name="city" type="text" aria-describedby="city">
				</div>
			</div>
			<div class="col-md-3">
				<div class="form-group">
					<label class="text-muted" for="state" ><i class="text-muted fa fa-map fa-fw mr-1"></i>State/Province</label>
					<input id="state" class="form-control" name="state" type="text" aria-describedby="state">
				</div>
			</div>
			<div class="col-md-2">
				<div class="form-group">
					<label class="text-muted" for="zip"><i class="text-muted fa fa-location-arrow fa-fw mr-1"></i>Zip</label>
					<input id="zip" class="form-control" name="zip" type="text" aria-describedby="zip">
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
			...
			<div class="col-md-12">
				<div class="form-group">
					...
					<input id="fax" class="form-control" name="fax" type="text" aria-describedby="fax">
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<input id="account" class="form-control" name="account" type="text" aria-describedby="account">
				</div>
			</div>
		</div>
		<div class="form-group row">
